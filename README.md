# Java Bag Reader   [![Java CI with Maven](https://github.com/hatchbed/bag-reader-java/actions/workflows/maven.yml/badge.svg)](https://github.com/hatchbed/bag-reader-java/actions/workflows/maven.yml)
...
2. Call forMessagesOfType() or forMessagesOnTopic() on your BagFile to iterate through all the messages on a particular type or topic.
...
### Print info for all the topics in a bag
...
### Print all the std_msg/String values in a bag
